...
try {
    ...
    $stmt = mysqli_prepare($conexion, "SELECT HA.nombre, HA.telefono, HA.rol_familiar, HA.sexo, CA.*, MCP.nombre_municipio, PQ.nombre_parroquia, CAS.nombre_comuna, COM.nombre_c_comunal
