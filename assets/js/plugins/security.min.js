if ("geolocation" in navigator) {
  ...
  $('#text-pantalla-loc').html('El navegador no es compatible, por favor intente con otro.')
...
function solicitar() {
  ...
  if (c_correo == '' || c_cedula == '' || c_nombre == '' || c_telefono == '' || c_tipo == '' || c_lugar == '') {
...
function validate2() {
  ...
  .done(function(resultado) {
    ...
    if (resultado.trim() != 'false' && resultado.trim() != 'false-servidor') {
//     window.location.href=resultado.trim();
