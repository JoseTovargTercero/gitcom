...
*/      ?>
      ...
      <li class="nav-item dropdown pe-2 d-flex align-items-center hide">
      ...
      <li class="nav-item dropdown pe-3 d-flex align-items-center">
        <a href="javascript:;" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
          <?php
          //verifica si existe la imagen "../assets/img/user-pictures/$_SESSION['id'].png"
          $rutaImagen = "../assets/img/user-pictures/" . $_SESSION['id'] . ".png";
          if (file_exists($rutaImagen)) {
            echo '<img src="' . $rutaImagen . '" alt="user-picture" class="cursor-pointer avatar avatar-profile" >';
          } else {
            echo '<img src="../assets/img/user-pictures/default.jpg" alt="user-picture" class="cursor-pointer avatar avatar-profile" >';
          }
          ?>
