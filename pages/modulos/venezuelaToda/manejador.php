  ...
  return $meses_ES[$mes];
    ...
    if ($result->num_rows > 0) {
      while ($r = $result->fetch_assoc()) {
        ...
        $archivo = '<hr><span class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2"> <span class="text-gray-400 ">Archivo de inventario: </span> <a class="text-primary" href="../../../empresas/files/'.$r['file'].'">Descargar archivo</a> </span> <br>';
