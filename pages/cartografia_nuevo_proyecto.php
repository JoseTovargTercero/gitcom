  ...
  <body class="g-sidenav-show  bg-gray-200">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="input-group input-group-outline my-3">
                  <select style="padding-left: 10px;border: 1px solid #d8d8d8;border-radius: 5px; color: #9c9c9c" required="" class="form-control" id="instancia">
    ...
    function remP(div, sect, id) {
      ...
      function guardarProject() {
        ...
        if (instancia == '' || categoria == '' || nombre == '' || descripcion == '' || tipo == '') {
