    ...
    ===================================================*/
		...
		*/
		...
		miArray['discapacidad'] = ['discapacidad!=""', 'personas']
		...
		miArray['niños no escolarizados'] = ['educacion="Sin estudio" AND edad>=0 AND edad<=2 OR educacion="No Escolarizado Inicial a Media General" AND edad>=0 AND edad<=2', 'personas']
		...
		miArray['personas que requieren ayuda tecnica'] = ['requiere_ayuda!=""', 'personas']
		
	
		miArray['jose gregorio hernandez'] = ['recibe_bono_jose_g!=""', 'personas']
		miArray['bono jose gregorio hernandez'] = ['recibe_bono_jose_g!=""', 'personas']
		miArray['atendidos con el bono jose gregorio hernandez'] = ['recibe_bono_jose_g!=""', 'personas']
		...
		miArray['puebo indigena curripaco'] = ['pueblo_indigena="Curripaco"', 'personas']
		...
		miArray['puebo indigena warequena'] = ['pueblo_indigena="Warequena"', 'personas']
		...
		miArray['media general incompleto'] = ['educacion="Media General Incompleto"', 'personas']
		...
		miArray['no escolarizado inicial a media general'] = ['educacion="No Escolarizado Inicial a Media General"', 'personas']
		miArray['postgrados'] = ['educacion="Postgrados"', 'personas']
		miArray['postgrado incompleto'] = ['educacion="Postgrado Incompleto"', 'personas']
		miArray['universitario'] = ['educacion="Universitario"', 'personas']
		miArray['universitario incompleto'] = ['educacion="Universitario Incompleto"', 'personas']
		/* educacion */
		...
		miArray['trabajador por cuenta propia (formal)'] = ['ocupacion="Trabajador por Cuenta Propia (Formal)"', 'personas']
		miArray['trabajador por cuenta propia (informal)'] = ['ocupacion="Trabajador por Cuenta Propia (Informal)"', 'personas']
		/* ocupacion */
		
		
		miArray['publico municipal'] = ['instancia_laboral="Publico Municipal"', 'personas']
		miArray['publico regional'] = ['instancia_laboral="Publico Regional"', 'personas']
		miArray['publico nacional'] = ['instancia_laboral="Publico Nacional"', 'personas']
		/* instancia laboral */
		
		miArray['bomberos'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Bomberos"', 'personas']
		miArray['cicpc'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="CICPC"', 'personas']
		miArray['armada'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Armada"', 'personas']
		miArray['aviación'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Aviación"', 'personas']
		miArray['ejercito'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Ejercito"', 'personas']
		miArray['guardia nacional'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Guardia Nacional"', 'personas']
		miArray['milicia'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Milicia"', 'personas']
		miArray['policia estadal'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Policia Estadal"', 'personas']
		miArray['policia municipa'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Policia Municipa"', 'personas']
		miArray['policia nacional'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Policia Nacional"', 'personas']
		miArray['protección civil'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="Protección Civil"', 'personas']
		miArray['sebin'] = ['pertenece_cuerpo_seguridad_gestion_riesgo="SEBIN"', 'personas']
		/* cuerpos de seguridad */
		
		
		miArray['artes plasticas'] = ['realiza_actividad_cultural="Artes Plasticas"', 'personas']
		miArray['baile'] = ['realiza_actividad_cultural="Baile"', 'personas']
		miArray['cuenta cuentos'] = ['realiza_actividad_cultural="Cuenta Cuentos"', 'personas']
		...
		miArray['creyente sin religion'] = ['creencia_reliosa="Creyente Sin Religion"', 'personas']
		...
		miArray['testigo de jehova'] = ['creencia_reliosa="Testigo de Jehova"', 'personas']
		miArray['ninguna religion (agnostico)'] = ['creencia_reliosa="Ninguna (Agnostico)"', 'personas']
		miArray['ninguna religion (ateo)'] = ['creencia_reliosa="Ninguna (Ateo)"', 'personas']
		/* religion */
		...
		miArray['integrantes del consejo comunal'] = ['concejo_comunal!=""', 'personas']
		...
		miArray['promotores comunitarios'] = ['promotores_comunitarios!=""', 'personas']
		...
		miArray['mesa tecnica de telecomunicaciones'] = ['mesa_tecnica_telecomunicaciones="SI"', 'personas']
		miArray['mesa tecnica de agua'] = ['mesa_tecnica_agua="SI"', 'personas']
		miArray['sala de barrio nuevo barrio tricolor'] = ['sala_bnbt="SI"', 'personas']